...
int main (int argc, char *argv[]){
	...
	gtk_tree_view_insert_column_with_attributes(GTK_TREE_VIEW(view), 0, "제목", renderer, "title",
FIRST_COLUMN, NULL);
	gtk_tree_view_insert_column_with_attributes(GTK_TREE_VIEW(view), 1, "번호", renderer, "text",
SECOND_COLUMN, NULL);
